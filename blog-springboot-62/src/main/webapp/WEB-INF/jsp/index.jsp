    ...
    <div class="content">
      ...
      <article class="excerpt excerpt-1">
      	<a class="focus" href="article.html" title="">
      		<img class="thumb" data-original="${a.titleimgs == null ? 'images/excerpt.jpg' : a.titleimgs }" src="images/excerpt.jpg" alt="">
     	 </a>
        ...
        <p class="note"><%=Util.subTag(a.getContent()).length() > 100 ? Util.subTag(a.getContent()).substring(0,100) : Util.subTag(a.getContent()) %></p>
      </article>
      </c:forEach>
